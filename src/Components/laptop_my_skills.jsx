...
function LaptopMySkills() {
    return <>
        <center>
            <div className="sample_laptop_my_skills_div_grand_parent">
                <font className='laptop_my_skills_font_1'>
                    <b>My</b>
                </font>
                <font className='laptop_my_skills_font_2'> <b>Skills</b>
                </font>
                <div className="sample_laptop_my_skills_parent">
                    <div className="sample_laptop_my_skills_parent_div1">
                        <br />
                        <font className='laptop_my_skills_font_3'>
                            <b>Programming Languages</b>
                        </font>
                        <div className="sample_laptop_my_skills_sub_parent">
                    ...
                    <div className="sample_laptop_my_skills_parent_div2">
                        <br />
                        <font className='laptop_my_skills_font_3'>
                            <b>Developer Tools</b>
                        </font>
                    ...
                    <div className="sample_laptop_my_skills_parent_div3">
                        <br />
                        <font className='laptop_my_skills_font_3'>
                            <b>Office Tools</b>
                        </font>
                    ...
                    <div className="sample_laptop_my_skills_parent_div4">
                        <br />
                        <font className='laptop_my_skills_font_3'>
                    ...
                    <div className="sample_laptop_my_skills_parent_div5">
                        <a href="/my-skills">
